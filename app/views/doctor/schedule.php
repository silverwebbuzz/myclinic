...
// START TIME, not by array index. Sessions are stored ordered by start_time, so
// when only one session is enabled it lands at index 0 — assuming index 0 ==
// morning previously loaded an evening session into the Morning fields.
