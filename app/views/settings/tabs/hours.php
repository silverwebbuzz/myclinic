...
<form method="post" action="/settings/hours" class="space-y-4">
    ...
    <div class="rounded-xl border bg-white p-5">
        <h3 class="flex items-center gap-2 text-base font-semibold">📅 Monday – Saturday sessions</h3>
    ...
    <div class="rounded-xl border bg-white p-5">
        <h3 class="flex items-center gap-2 text-base font-semibold">🗓️ Sunday</h3>
    ...
    <div class="rounded-xl border bg-white p-5">
        <h3 class="flex items-center gap-2 text-base font-semibold text-red-700">🚨 Extended hours (walk-in admin only)</h3>
    ...
    <div class="rounded-xl border bg-white p-5">
        <h3 class="flex items-center gap-2 text-base font-semibold">📆 Online booking window</h3>
