...
$DATA = [
    ...
    'specialty_groups' => [
        ...
        [
            ...
            'items' => [
                ...
                ['id' => 'homeopathy',  'label' => 'Homoeopath',         'icon' => '🌿'],
    ...
    'doctors' => [
        ...
        ['id' => 2,  'name' => 'Dr. Priya Iyer',    'firstInitial' => 'P', 'lastInitial' => 'I', 'qual' => 'BHMS, MD (Hom)',     'years' => 11, 'spec' => 'homeopathy', 'specLabel' => 'Homeopathy', 'verified' => true,  'video' => true,  'gender' => 'F', 'rating' => 4.9, 'reviews' => 142, 'langs' => ['English', 'Hindi', 'Marathi'], 'hospital' => 'Iyer Homeopathy', 'area' => 'Aundh', 'city' => 'Pune', 'state' => 'Maharashtra', 'country' => 'IN', 'countryName' => 'India', 'currency' => '₹', 'fee' => 500, 'next' => ['when' => 'tomorrow', 'label' => 'Tomorrow 10:00 AM', 'sub' => '']],
        ...
        ['id' => 4,  'name' => 'Dr. Rohit Kapoor',  'firstInitial' => 'R', 'lastInitial' => 'K', 'qual' => 'BHMS',               'years' => 18, 'spec' => 'homeopathy', 'specLabel' => 'Homeopathy', 'verified' => true,  'video' => true,  'gender' => 'M', 'rating' => 4.7, 'reviews' => 211, 'langs' => ['English', 'Hindi', 'Punjabi'], 'hospital' => 'Kapoor Clinic', 'area' => 'Connaught Place', 'city' => 'Delhi', 'state' => 'Delhi', 'country' => 'IN', 'countryName' => 'India', 'currency' => '₹', 'fee' => 700, 'next' => ['when' => 'later',  'label' => 'In 3 days',       'sub' => '']],
