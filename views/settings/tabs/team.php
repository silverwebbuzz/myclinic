...
<div class="space-y-6">
    <div class="rounded-xl border bg-white p-6">
        <h2 class="text-lg font-semibold">Team & seats</h2>
    ...
    <div class="rounded-xl border bg-white p-6" x-data="{ open: false }">
        ...
        <form x-show="open" x-transition method="post" action="/settings/team/invite" class="mt-4 grid gap-3 sm:grid-cols-2">
            ...
            <label class="text-sm">Name <input name="name" required class="mt-1 w-full rounded-lg border px-3 py-2 text-sm"></label>
            <label class="text-sm">Email <input type="email" name="email" required class="mt-1 w-full rounded-lg border px-3 py-2 text-sm"></label>
            ...
            <div class="sm:col-span-2">
                <button type="submit" class="rounded-lg bg-emerald-600 px-4 py-2 text-sm font-medium text-white">Send invite</button>
            </div>
        </form>
    </div>
