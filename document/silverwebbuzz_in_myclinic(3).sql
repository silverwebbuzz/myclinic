...
--
-- Table structure for table `audit_data_access`
--
...
CREATE TABLE `clinic_settings` (
  `clinic_id` bigint(20) UNSIGNED NOT NULL,
  `visible_modules` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`visible_modules`)),
  `section_state` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`section_state`)),
  `default_visit_template_id` bigint(20) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `diet_plans` (
  ...
  `share_token_expires` timestamp NULL DEFAULT NULL,
...
--
-- Table structure for table `diet_templates`
--
...
--
-- Table structure for table `directory_leads`
--
...
CREATE TABLE `directory_leads` (
  ...
  `view_token` char(16) DEFAULT NULL,
  `source` varchar(40) NOT NULL DEFAULT 'find-a-doctor',
  `referrer` varchar(255) DEFAULT NULL,
  `ip` varchar(45) DEFAULT NULL,
  `user_agent` varchar(255) DEFAULT NULL,
  `sms_sent_at` datetime DEFAULT NULL,
  `sms_provider_id` varchar(60) DEFAULT NULL,
  `sms_status` enum('pending','sent','suppressed_quota','suppressed_quiet','suppressed_paused','failed','not_applicable') NOT NULL DEFAULT 'pending',
  `doctor_viewed_at` datetime DEFAULT NULL,
  `doctor_view_count` smallint(5) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Table structure for table `directory_sms_quotas`
--
...
CREATE TABLE `directory_sms_quotas` (
  ...
  `per_week` tinyint(3) UNSIGNED DEFAULT NULL,
  `per_month` smallint(5) UNSIGNED DEFAULT NULL,
  `is_paused` tinyint(1) NOT NULL DEFAULT 0,
  `paused_at` datetime DEFAULT NULL,
  `pause_reason` varchar(120) DEFAULT NULL,
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `directory_sms_settings`
--

CREATE TABLE `directory_sms_settings` (
  `id` tinyint(3) UNSIGNED NOT NULL DEFAULT 1,
  `enabled` tinyint(1) NOT NULL DEFAULT 1,
  `default_per_day` tinyint(3) UNSIGNED NOT NULL DEFAULT 2,
  `default_per_week` tinyint(3) UNSIGNED NOT NULL DEFAULT 5,
  `default_per_month` smallint(5) UNSIGNED NOT NULL DEFAULT 20,
  `provider_template_id` varchar(60) DEFAULT NULL,
  `template_body` text NOT NULL DEFAULT 'eClinicPro: {patient_name} wants to book you {date} at {time}. View: {url} Reply STOP to opt out.',
...
--
-- Table structure for table `doctor_claim_requests`
--
...
CREATE TABLE `doctor_claim_requests` (
  ...
  `reg_council` varchar(80) DEFAULT NULL,
  `document_path` varchar(255) DEFAULT NULL,
  `message` text DEFAULT NULL,
  `status` enum('pending','phone_verified','approved','rejected','duplicate') NOT NULL DEFAULT 'pending',
  `reviewed_by` bigint(20) UNSIGNED DEFAULT NULL,
  `reviewed_at` datetime DEFAULT NULL,
  `reviewer_notes` text DEFAULT NULL,
  `created_tenant_id` bigint(20) UNSIGNED DEFAULT NULL,
  `created_user_id` bigint(20) UNSIGNED DEFAULT NULL,
  `ip` varchar(45) DEFAULT NULL,
  `user_agent` varchar(255) DEFAULT NULL,
  `source` varchar(40) NOT NULL DEFAULT 'find_a_doctor',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `doctor_otp_codes`
--
...
CREATE TABLE `feature_flags` (
  ...
  `beta_tenant_ids` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`beta_tenant_ids`)),
...
CREATE TABLE `founding_clinic_state` (
  ...
  `cap` int(11) NOT NULL DEFAULT 100,
...
--
-- Table structure for table `patient_clinic_consents`
--

CREATE TABLE `patient_clinic_consents` (
  `identity_id` bigint(20) UNSIGNED NOT NULL,
  `clinic_id` bigint(20) UNSIGNED NOT NULL,
  `scope` longtext DEFAULT NULL CHECK (json_valid(`scope`)),
...
--
-- Table structure for table `patient_wishlist`
--
...
CREATE TABLE `prescriptions` (
  ...
  `tapering_steps` longtext DEFAULT NULL CHECK (`tapering_steps` is null or json_valid(`tapering_steps`)),
...
CREATE TABLE `symptoms_master` (
  ...
  `global_usage_count` int(11) NOT NULL DEFAULT 0,
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `symptoms_personal`
--
...
CREATE TABLE `symptoms_personal` (
  ...
  `promoted_to_master_id` bigint(20) UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

--
-- Table structure for table `template_usage_log`
--
...
CREATE TABLE `tenants` (
  ...
  `specialty` varchar(40) DEFAULT 'gp',
  `country_code` char(2) DEFAULT 'IN',
  `currency` char(3) DEFAULT 'INR',
  `timezone` varchar(50) DEFAULT 'Asia/Kolkata',
  `plan` enum('standard') NOT NULL DEFAULT 'standard',
  `is_founding_clinic` tinyint(1) NOT NULL DEFAULT 0,
  `founding_clinic_locked_at` timestamp NULL DEFAULT NULL,
  `founding_clinic_locked_until` date DEFAULT NULL,
  `plan_expires_at` date DEFAULT NULL,
  `trial_ends_at` date DEFAULT NULL,
  `trial_extension_granted` tinyint(1) NOT NULL DEFAULT 0,
  `trial_extension_granted_at` timestamp NULL DEFAULT NULL,
  `trial_extension_granted_by` bigint(20) UNSIGNED DEFAULT NULL,
  ...
  `email` varchar(150) DEFAULT NULL,
  `is_active` tinyint(1) DEFAULT 1,
  `is_directory_listed` tinyint(1) NOT NULL DEFAULT 0,
  `directory_doctor_id` bigint(20) UNSIGNED DEFAULT NULL,
...
CREATE TABLE `visits` (
  ...
  `specialty_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`specialty_data`)),
  `auto_save_data` longtext DEFAULT NULL CHECK (`auto_save_data` is null or json_valid(`auto_save_data`)),
...
--
-- Indexes for table `audit_data_access`
--
ALTER TABLE `audit_data_access`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_audit_identity_time` (`identity_id`,`accessed_at`),
  ADD KEY `idx_audit_clinic_time` (`accessed_by_clinic_id`,`accessed_at`);
...
ALTER TABLE `clinic_modules`
  ...
  ADD KEY `idx_clinic_modules_clinic_active` (`clinic_id`,`is_active`);
...
ALTER TABLE `diet_plans`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_diet_share_token` (`share_token`),
  ...
  ADD KEY `idx_diet_plans_template` (`template_id`);

--
-- Indexes for table `diet_templates`
--
ALTER TABLE `diet_templates`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_diet_clinic_doctor` (`clinic_id`,`doctor_id`,`is_active`),
  ADD KEY `idx_diet_condition` (`condition_tag`),
  ADD KEY `fk_dt_doctor` (`doctor_id`);
...
ALTER TABLE `directory_doctors`
  ...
  ADD KEY `idx_dir_active_quality` (`is_active`,`status`,`quality_score`),
  ADD KEY `idx_dir_doctor_name` (`doctor_name`),
  ADD KEY `idx_dir_country_spec_quality` (`country`,`specialty`,`is_active`,`status`,`quality_score`),
  ADD KEY `idx_dir_claimed_quality` (`is_claimed`,`quality_score`,`rating`),
  ADD KEY `idx_dir_area_city` (`area`,`city`),
  ADD KEY `idx_dir_latlng` (`lat`,`lng`);
ALTER TABLE `directory_doctors` ADD FULLTEXT KEY `ft_dir_names` (`name`,`doctor_name`);

--
-- Indexes for table `directory_leads`
--
ALTER TABLE `directory_leads`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_dl_view_token` (`view_token`),
  ADD KEY `idx_dl_doctor_created` (`directory_doctor_id`,`created_at`),
  ADD KEY `idx_dl_identity` (`patient_identity_id`),
  ADD KEY `idx_dl_type_created` (`type`,`created_at`),
  ADD KEY `idx_dl_sms_status` (`sms_status`);

--
-- Indexes for table `directory_sms_quotas`
--
ALTER TABLE `directory_sms_quotas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_dsq_doctor` (`directory_doctor_id`);

--
-- Indexes for table `directory_sms_settings`
--
ALTER TABLE `directory_sms_settings`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `doctor_claim_requests`
--
ALTER TABLE `doctor_claim_requests`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_dcr_status_created` (`status`,`created_at`),
  ADD KEY `idx_dcr_directory_doctor` (`directory_doctor_id`),
  ADD KEY `idx_dcr_phone` (`phone`),
  ADD KEY `idx_dcr_type_status` (`type`,`status`);
...
--
-- Indexes for table `doctor_otp_codes`
--
ALTER TABLE `doctor_otp_codes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_doc_otp_phone_purpose` (`phone`,`purpose`),
  ADD KEY `idx_doc_otp_expires` (`expires_at`);
...
ALTER TABLE `doctor_sessions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_doc_sess_user` (`user_id`),
  ADD KEY `idx_doc_sess_expires` (`expires_at`);
...
ALTER TABLE `drugs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_drugs_usage` (`usage_count` DESC,`name`);
...
ALTER TABLE `patients`
  ...
  ADD KEY `idx_patients_phone_global` (`phone`),
  ADD KEY `idx_patients_identity_clinic` (`identity_id`,`clinic_id`);
...
--
-- Indexes for table `patient_clinic_consents`
--
ALTER TABLE `patient_clinic_consents`
  ADD PRIMARY KEY (`identity_id`,`clinic_id`),
  ADD KEY `idx_consent_clinic` (`clinic_id`),
  ADD KEY `idx_consent_revoked` (`revoked_at`);
...
--
-- Indexes for table `patient_wishlist`
--
ALTER TABLE `patient_wishlist`
  ADD PRIMARY KEY (`identity_id`,`doctor_id`),
  ADD KEY `idx_wishlist_doctor` (`doctor_id`);
...
ALTER TABLE `prescriptions`
  ...
  ADD KEY `idx_prescriptions_visit_sort` (`visit_id`,`sort_order`);
...
ALTER TABLE `prescription_shares`
  ...
  ADD KEY `idx_share_prescription` (`prescription_id`),
  ADD KEY `idx_share_identity` (`identity_id`);
...
ALTER TABLE `prescription_templates`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_templates_doctor` (`doctor_id`,`use_count` DESC),
  ADD KEY `idx_templates_clinic` (`clinic_id`,`use_count` DESC);

--
-- Indexes for table `prescription_template_items`
--
ALTER TABLE `prescription_template_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template_items` (`template_id`,`sort_order`),
  ADD KEY `fk_template_items_drug` (`drug_id`),
  ADD KEY `fk_template_items_remedy` (`remedy_id`);
...
ALTER TABLE `remedies`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_remedies_usage` (`usage_count` DESC,`name`);
...
ALTER TABLE `symptoms_master`
  ...
  ADD KEY `idx_symptoms_master_label` (`label`),
  ADD KEY `idx_symptoms_master_active` (`is_active`,`global_usage_count`);

--
-- Indexes for table `symptoms_personal`
--
ALTER TABLE `symptoms_personal`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_doctor_label` (`doctor_id`,`label`),
  ADD KEY `idx_personal_recent` (`doctor_id`,`last_used_at` DESC),
  ADD KEY `fk_personal_clinic` (`clinic_id`),
  ADD KEY `fk_personal_promoted` (`promoted_to_master_id`);

--
-- Indexes for table `template_usage_log`
--
ALTER TABLE `template_usage_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template_log_doctor` (`doctor_id`,`applied_at` DESC),
  ADD KEY `idx_template_log_template` (`template_id`,`applied_at` DESC),
  ADD KEY `fk_tul_clinic` (`clinic_id`),
  ADD KEY `fk_tul_visit` (`visit_id`);
...
ALTER TABLE `tenants`
  ...
  ADD KEY `fk_tenants_directory_doctor` (`directory_doctor_id`),
  ADD KEY `idx_tenants_founding` (`is_founding_clinic`),
  ADD KEY `idx_tenants_trial_ends` (`trial_ends_at`);
...
ALTER TABLE `users`
  ...
  ADD KEY `idx_users_phone_role` (`phone`,`role`);
...
ALTER TABLE `visits`
  ...
  ADD KEY `idx_visits_draft_cleanup` (`status`,`last_autosave_at`);
...
ALTER TABLE `visit_symptoms`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_vs_visit` (`visit_id`,`sort_order`),
  ADD KEY `idx_vs_master` (`master_id`),
  ADD KEY `fk_vs_clinic` (`clinic_id`);
...
--
-- AUTO_INCREMENT for table `audit_data_access`
--
ALTER TABLE `audit_data_access`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `diet_templates`
--
ALTER TABLE `diet_templates`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `directory_leads`
--
ALTER TABLE `directory_leads`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `directory_sms_quotas`
--
ALTER TABLE `directory_sms_quotas`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `doctor_claim_requests`
--
ALTER TABLE `doctor_claim_requests`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `doctor_otp_codes`
--
ALTER TABLE `doctor_otp_codes`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `prescription_shares`
--
ALTER TABLE `prescription_shares`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `prescription_template_items`
--
ALTER TABLE `prescription_template_items`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `symptoms_personal`
--
ALTER TABLE `symptoms_personal`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `template_usage_log`
--
ALTER TABLE `template_usage_log`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `audit_data_access`
--
ALTER TABLE `audit_data_access`
  ADD CONSTRAINT `fk_ada_identity` FOREIGN KEY (`identity_id`) REFERENCES `patient_identities` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `clinic_settings`
  ADD CONSTRAINT `fk_clinic_settings_clinic` FOREIGN KEY (`clinic_id`) REFERENCES `tenants` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `diet_templates`
--
ALTER TABLE `diet_templates`
  ADD CONSTRAINT `fk_dt_clinic` FOREIGN KEY (`clinic_id`) REFERENCES `tenants` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_dt_doctor` FOREIGN KEY (`doctor_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `directory_leads`
--
ALTER TABLE `directory_leads`
  ADD CONSTRAINT `fk_dl_doctor` FOREIGN KEY (`directory_doctor_id`) REFERENCES `directory_doctors` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_dl_identity` FOREIGN KEY (`patient_identity_id`) REFERENCES `patient_identities` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `directory_sms_quotas`
--
ALTER TABLE `directory_sms_quotas`
  ADD CONSTRAINT `fk_dsq_doctor` FOREIGN KEY (`directory_doctor_id`) REFERENCES `directory_doctors` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `doctor_sessions`
  ADD CONSTRAINT `fk_doc_sess_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `patient_clinic_consents`
--
ALTER TABLE `patient_clinic_consents`
  ADD CONSTRAINT `fk_pcc_clinic` FOREIGN KEY (`clinic_id`) REFERENCES `tenants` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_pcc_identity` FOREIGN KEY (`identity_id`) REFERENCES `patient_identities` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `patient_wishlist`
--
ALTER TABLE `patient_wishlist`
  ADD CONSTRAINT `fk_pwl_doctor` FOREIGN KEY (`doctor_id`) REFERENCES `directory_doctors` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_pwl_identity` FOREIGN KEY (`identity_id`) REFERENCES `patient_identities` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `prescription_shares`
  ADD CONSTRAINT `fk_psh_identity` FOREIGN KEY (`identity_id`) REFERENCES `patient_identities` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_psh_prescription` FOREIGN KEY (`prescription_id`) REFERENCES `prescriptions` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `prescription_templates`
--
ALTER TABLE `prescription_templates`
  ADD CONSTRAINT `fk_templates_clinic` FOREIGN KEY (`clinic_id`) REFERENCES `tenants` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_templates_doctor` FOREIGN KEY (`doctor_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `prescription_template_items`
--
ALTER TABLE `prescription_template_items`
  ADD CONSTRAINT `fk_template_items` FOREIGN KEY (`template_id`) REFERENCES `prescription_templates` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_template_items_drug` FOREIGN KEY (`drug_id`) REFERENCES `drugs` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_template_items_remedy` FOREIGN KEY (`remedy_id`) REFERENCES `remedies` (`id`) ON DELETE SET NULL;
...
--
-- Constraints for table `symptoms_personal`
--
ALTER TABLE `symptoms_personal`
  ADD CONSTRAINT `fk_personal_clinic` FOREIGN KEY (`clinic_id`) REFERENCES `tenants` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_personal_doctor` FOREIGN KEY (`doctor_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_personal_promoted` FOREIGN KEY (`promoted_to_master_id`) REFERENCES `symptoms_master` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `template_usage_log`
--
ALTER TABLE `template_usage_log`
  ADD CONSTRAINT `fk_tul_clinic` FOREIGN KEY (`clinic_id`) REFERENCES `tenants` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_tul_doctor` FOREIGN KEY (`doctor_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_tul_template` FOREIGN KEY (`template_id`) REFERENCES `prescription_templates` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_tul_visit` FOREIGN KEY (`visit_id`) REFERENCES `visits` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `tenants`
--
ALTER TABLE `tenants`
  ADD CONSTRAINT `fk_tenants_directory_doctor` FOREIGN KEY (`directory_doctor_id`) REFERENCES `directory_doctors` (`id`) ON DELETE SET NULL;
...
--
-- Constraints for table `visit_symptoms`
--
ALTER TABLE `visit_symptoms`
  ADD CONSTRAINT `fk_vs_clinic` FOREIGN KEY (`clinic_id`) REFERENCES `tenants` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_vs_master` FOREIGN KEY (`master_id`) REFERENCES `symptoms_master` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_vs_visit` FOREIGN KEY (`visit_id`) REFERENCES `visits` (`id`) ON DELETE CASCADE;
